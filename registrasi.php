...
<html lang="en">
    <head>
        ...
        <title>Registerasi Ke Perpustakaan Digital</title>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Registerasi Perpustakaan Digital</h3></div>
                                    <div class="card-body">
                                       <?php
                                            ...
                                            if($insert){
                                                echo '<script>alert("Selamat Registras Anda Berhasil"); location.href="index.php";</script>';
                                          
                                            }else
                                                echo '<scrpit>alert("Registrasi Anda Gagal. Silahkan Ulangi kembali");</script>';
                                        }
